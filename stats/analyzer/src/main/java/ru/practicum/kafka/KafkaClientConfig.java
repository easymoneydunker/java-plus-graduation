...
public class KafkaClientConfig {
    ...
    public Properties getKafkaConsumerUserActionProperties() {
        log.info("{}: Creating Properties for UserAction consumer", KafkaClientConfig.class.getSimpleName());
    ...
    public Properties getKafkaConsumerEventSimilarityProperties() {
        log.info("{}: Creating Properties for EventSimilarity consumer", KafkaClientConfig.class.getSimpleName());
        return new Properties();
    }
    ...
    KafkaClient getKafkaClient() {
        return new KafkaClient() {
            ...
            public Consumer<Long, UserActionAvro> getKafkaUserActionConsumer() {
                log.info("{}: Initializing UserActionConsumer", KafkaClientConfig.class.getSimpleName());
            ...
            public Consumer<Long, EventSimilarityAvro> getKafkaEventSimilarityConsumer() {
                log.info("{}: Initializing EventSimilarityConsumer", KafkaClientConfig.class.getSimpleName());
            ...
            public void close() {
                try {
                    ...
                    log.info("{}: Closing UserActionConsumer", KafkaClientConfig.class.getSimpleName());
                    kafkaUserActionConsumer.close();
                    log.info("{}: Closing EventSimilarityConsumer", KafkaClientConfig.class.getSimpleName());
